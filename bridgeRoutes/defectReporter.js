...
const database = require("../v2/utils/database");
const tables = require("../v2/constants/tableNames");
const AppError = require("../v2/utils/appError");
const sendMail = require("../v2/utils/sendMail");
    ...
    async function (req, res, next) {
        ...
        try {
            ...
            const defectReportEmail = require(
                `../v2/emailTemplates/${language}/defectReportEmail`,
            );
